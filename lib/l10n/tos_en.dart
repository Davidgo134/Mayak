...
Terms of use for the unofficial MAX client named "MayakClient" or "Mayak"

1. Status and relationships
1.1. "Mayak" (the "App") is an unofficial third-party application and is not affiliated with Communication Platform LLC (rights holder of the "MAX" service).
...
• Using "Mayak" to distribute prohibited content
...
• "Mayak" uses publicly available interaction methods with "MAX", similar to the web client (https://web.max.ru)
...
3. Technical aspects
3.1. "Mayak" uses only publicly available methods to interact with "MAX" through official endpoints.
...
4. Privacy
4.1. "Mayak" does not store or process users' personal data on developers' servers.
...
5.1. "Mayak" is provided "as is" without warranties.
5.2. The developers may discontinue support at any time without notice.

6. Legal basis
6.1. Development and distribution of "Mayak" are carried out with regard to interoperability, fair use, and publicly available information principles, including EU Directive 2019/790 on interoperability where applicable.
...
6.3. "Mayak" does not circumvent technical protection measures or disrupt the normal operation of the original service.

7. Final provisions
7.1. By using "Mayak", you agree that:
...
8.1. "Mayak" may include privacy tools:
...
8.4.1. "Mayak" may allow exporting and importing session data for:
