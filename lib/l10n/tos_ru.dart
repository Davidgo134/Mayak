...
Условия использования неофициального клиента на MAX, именуемым "MayakClient" или же "Маяк"

1. Статус и отношения
1.1. «Маяк» (далее — «Приложение») — неофициальное стороннее приложение, не имеющее отношения к ООО «Коммуникационная платформа" (правообладатель сервиса «MAX").
...
2.1. Используя Приложение «Маяк», вы:
...
• Использовать Приложение «Маяк» для распространения запрещённого контента;
...
• Приложение «Маяк» использует публично доступные методы взаимодействия с сервисом «MAX», аналогичные веб-версии (https://web.max.ru)
...
3.1. Приложение «Маяк» использует только публично доступные методы взаимодействия с сервисом «MAX» через официальные конечные точки.
...
4.1. Приложение «Маяк» не хранит и не обрабатывает персональные данные пользователей.
...
5.1. Приложение «Маяк» предоставляется «как есть» (as is) без гарантий работоспособности.
5.2. Разработчики вправе прекратить поддержку Приложения в любой момент без объяснения причин.

6. Правовые основания
6.1. Разработка и распространение Приложения «Маяк» осуществляются в соответствии с:
...
6.3. Приложение «Маяк» не обходит технические средства защиты и не нарушает нормальную работу оригинального сервиса, что соответствует требованиям статьи 1299 ГК РФ.

7. Заключительные положения
7.1. Используя Приложение «Маяк», вы соглашаетесь с тем, что:
...
8.1. Приложение «Маяк» включает инструменты защиты приватности:
...
8.4.1. Приложение «Маяк» предоставляет возможность экспорта и импорта данных сессии для:
